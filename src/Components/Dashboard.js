...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    if (!checkToken()) {
      ...
      //check local storage
      //if there is nothing in local storage then add the userId to local storage.
      //Else use local storage Id to get the blog items by id
  ...
  //Images (read image file and create a url that we can use as an actual iamge)
